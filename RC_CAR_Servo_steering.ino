...
//Lights
int Headlight = 5;        //These digital pins are not at all connected to the L293D module so can be used
int Taillight = 13;

//Horn
int Honky = 3;      //Connected to the M2 which is connected to the digital pin 3
...
void loop() {
  ...
  //Motor speed
  case '0': motor1.setSpeed(0); motor2.setSpeed(0); break;
  case '1': motor1.setSpeed(25); motor2.setSpeed(25); break;
  case '2': motor1.setSpeed(50); motor2.setSpeed(50); break;
  case '3': motor1.setSpeed(75); motor2.setSpeed(75); break;
  case '4': motor1.setSpeed(100); motor2.setSpeed(100); break;
  case '5': motor1.setSpeed(125); motor2.setSpeed(125); break;
  case '6': motor1.setSpeed(150); motor2.setSpeed(150); break;
  case '7': motor1.setSpeed(175); motor2.setSpeed(175); break;
  case '8': motor1.setSpeed(200); motor2.setSpeed(200); break;
  case '9': motor1.setSpeed(225); motor2.setSpeed(225); break;
  case 'q': motor1.setSpeed(255); motor2.setSpeed(255); break;
